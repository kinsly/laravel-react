                        ...
                        <form action="{{ route('items.store') }}" method="post">
                          @csrf
                            ...
                            <div class="col-md-6 mt-3 mb-2">
                              ...
                              <x-partials.image-upload id='1' :image="old('imagePath')"/>
                            ...
                            <div>
                              ...
                              <textarea class="form-control @error('card_info') is-invalid @enderror" 
                                name="card_info" id="card_info" rows="3">{{old('card_info')}}</textarea>
                            ...
                            <div>
                              ...
                              <textarea class="form-control 
                                @error('summary') is-invalid @enderror" name="summary" id="summary" rows="3">{{old('summary')}}</textarea>
                            ...
                            <div>
                              <div>
                                <x-partials.rich-text-editor id="id" :text="old('description')" title="Description" inputName="description"/>  
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="mb-3">
                                  ...
                                  <select id="isAvailable" class="form-select" name="isAvailable">
                                    <option value=1 @if(old('isAvailable') == 1) selected @endif>Yes</option>
                                    <option value=0 @if(old('isAvailable') == 0) selected @endif>No</option>
                                  </select>
                                  ...
                                  <select id="fd_category_id" class="form-select" name="fd_category_id">
                                    ...
                                    @foreach ($categories as $category)
                                      <option value={{$category->id}} 
                                        @if(old('fd_category_id') == $category->id) selected @endif
